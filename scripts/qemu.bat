...
"C:\Program Files\qemu\qemu-system-i386.exe" ..\..\os.img -soundhw ac97 -net nic,model=e1000 -serial file:serial.txtd  -m 256 -D qemu.log -net tap,ifname=TAP  -usbdevice mouse -drive if=none,id=usbstick,file=..\..\usbb.img -device usb-ehci,id=ehci -device usb-storage,bus=ehci.0,drive=usbstick
