...
"C:\Program Files\qemu\qemu-system-i386.exe" ..\..\os.img -soundhw ac97 -net nic,model=e1000 -serial file:serial.txtd  -m 256 -D qemu.log  -usbdevice mouse -drive file=..\..\usbb.img,if=none,id=nvm -device nvme,drive=nvm,serial=1234 -drive if=none,id=usbstick,file=..\..\os_1.img -device usb-storage,drive=usbstick
